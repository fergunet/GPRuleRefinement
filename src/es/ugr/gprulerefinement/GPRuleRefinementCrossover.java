...
public class GPRuleRefinementCrossover extends OsgiliathService implements Crossover{
	...
	public ArrayList<Genome> cross(Genome mother, Genome father) {
		...
		int maxDepth = (Integer) this.getAlgorithmParameters().getParameter(GPRuleRefinementParameters.MAX_DEPTH);
